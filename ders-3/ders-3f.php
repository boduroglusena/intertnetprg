...
class CalismaOdasi extends Kutuphane
{
    ...
    public function getInfo() 
   {
     ...
     $isim      = $this->libraryName; /* exend denilen sınıfın içersindeki public değişkenlere $this ile erişilebilir */
   
     $kurulus   = self::YEAR; /* exend edilen sınıfın içerisindeki sabitlere self:: ile erişilebilir */
